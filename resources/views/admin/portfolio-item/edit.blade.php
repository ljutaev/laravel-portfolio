...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Create Portfolio Item</h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.portfolio-item.update', $item->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea name="description" class="summernote">{{ $item->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input name="client" type="text" class="form-control" value="{{ $item->client }}">
                                </div>
                            </div>
