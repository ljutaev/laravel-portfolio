...
<div class="form-inline mr-auto"></div>
    <ul class="navbar-nav navbar-right">
        ...
        <div class="d-sm-none d-lg-inline-block">Hi, {{$user->name ??'Guest'}}</div></a>
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <x-dropdown-link class="dropdown-item has-icon text-danger" :href="route('logout')"
...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.service.index') }}" class="nav-link"><i class="fas fa-square"></i><span>Services</span></a>
            </li>
            <li class="nav-item">
                <a href="{{ route('admin.about.index') }}" class="nav-link"><i class="fas fa-square"></i><span>About</span></a>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li><a class="nav-link" href="{{ route('admin.portfolio-section-setting.index') }}">Section Secting</a></li>
