...
<header class="header-area parallax-bg" id="home-page" style="background: url({{$hero->image}}) no-repeat scroll top center/cover">
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
...
@push('scripts')
<script>
jQuery('.header-area .typer-title').typer( {!! $typerTitles !!} );
</script>
@endpush